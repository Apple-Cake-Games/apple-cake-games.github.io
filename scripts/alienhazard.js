...
function update() {
  ...
  if (
    currentCoin &&
    checkCollision(playerRect, currentCoin.getBoundingClientRect())
  ) {
    score++;
  ...
  if (
    shieldElement &&
    checkCollision(playerRect, shieldElement.getBoundingClientRect())
  ) {
